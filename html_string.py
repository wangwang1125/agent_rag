...
<body>
    <header>
        <h1>智能医疗问答系统</h1>
        <p style="color: #e3f2fd; font-size: 1.1em; margin-top: 0.5em;">支持RAG知识库问答 & 多智能体健康分析</p>
    </header>
    <main>
        ...
        <ul>
            ...
            <li><a href="/chat"><span class="material-icons"></span> 3. 智能问答</a></li>
        </ul>
    </main>
</body>
</html>"""
...
<html lang="zh">
    ...
    <body>
        <ul class="links-container">
            ...
            <li><a href="/chat"><span class="material-icons">question_answer</span> 智能问答</a></li>
        </ul>
    </body>
</html>"""
